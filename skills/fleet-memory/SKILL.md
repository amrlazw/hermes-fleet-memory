---
name: fleet-memory
description: Use when recalling or storing architecture, hardware specs, GPU settings, payment APIs, or cross-node notes across the Hermes fleet memory mesh.
version: 1.3.0
author: Amirul Azwan
license: MIT
---
